...
::: {.incremental}
- [Conditional Probability — Definition](#conditional-probability)
- [Bayes' Rule](#bayes-rule)
- [Law of Total Probability](#lotp)
- [Testing for a Disease](#testing-disease)
- [Independence](#independence)
- [The Monty Hall Problem](#monty-hall)
- [Simpson's Paradox](#simpsons-paradox)
- [Sequential Battle (Conditioning as a Tool)](#sequential-battle)
:::
...
(function(){
  ...
  const pileCx = x0 + (3*(blockW+gap)+blockW)/2;
  const pileCy = (yTop+yBot)/2;
...
(function () {
  ...
  const N_BIN1_RED = 40, N_BIN1_BLUE = 20;
  const N_BIN2_RED = 30, N_BIN2_BLUE = 30;
  const N_BLUE = N_BIN1_BLUE + N_BIN2_BLUE;
  const N_RED = N_BIN1_RED + N_BIN2_RED;
...
## Simpson's Paradox in COVID-19 Case Fatality Rates {#simpsons-paradox}
...
## Using conditioning as a tool: sequential battle {#sequential-battle}
